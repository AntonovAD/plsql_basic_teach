...
--типы под заголовки
create or replace type student.t_fetch_header as object (
    name varchar2(50),
    value varchar2(100)
);

create or replace type student.t_arr_fetch_header as table of student.t_fetch_header;



create or replace function student.http_fetch
(
    ...
    p_headers student.t_arr_fetch_header default null, --заголовки запроса
...
begin
    ...
    loop
    declare
        v_header student.t_fetch_header := p_headers(i);
    begin
